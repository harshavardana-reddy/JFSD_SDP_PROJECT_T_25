  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${BackendURLS.Faculty}/uploadassignment`,
        formData,
        {
      ...
      toast.update(toastId, {
        render: "Assignment uploaded successfully!",
        type: "success",
        isLoading: false,
        autoClose: 3000,
      });
      ...
      toast.update(toastId, {
        render: "Failed to upload assignment. Please try again.",
        type: "error",
        isLoading: false,
        autoClose: 3000,
      });
      ...
      <div className="p-4 bg-gray-200 shadow-lg rounded-md" id="wrapper">
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <InputLabel>Assignment Question PDF <p style={{color:'red'}} >Note : Upload Only in PDF Format.</p></InputLabel>
            <input
              type="file"
              accept=".pdf,.doc"
